...
INSERT INTO CARDAPIO(id, id_creche, dt_cardapio, dia_semana)VALUES((select (max(id) + 1) from  CARDAPIO),1,current_date - 1,to_char(current_date - 1, 'day'));
INSERT INTO CARDAPIO(id, id_creche, dt_cardapio, dia_semana)VALUES((select (max(id) + 1) from  CARDAPIO),1,current_date - 2,to_char(current_date - 2, 'day'));
INSERT INTO CARDAPIO(id, id_creche, dt_cardapio, dia_semana)VALUES((select (max(id) + 1) from  CARDAPIO),1,current_date - 3,to_char(current_date - 3, 'day'));
INSERT INTO CARDAPIO(id, id_creche, dt_cardapio, dia_semana)VALUES((select (max(id) + 1) from  CARDAPIO),1,current_date - 4,to_char(current_date - 4, 'day'));
INSERT INTO CARDAPIO(id, id_creche, dt_cardapio, dia_semana)VALUES((select (max(id) + 1) from  CARDAPIO),1,current_date - 5,to_char(current_date - 5, 'day'));
INSERT INTO CARDAPIO(id, id_creche, dt_cardapio, dia_semana)VALUES((select (max(id) + 1) from  CARDAPIO),1,current_date - 6,to_char(current_date - 6, 'day'));
INSERT INTO CARDAPIO(id, id_creche, dt_cardapio, dia_semana)VALUES((select (max(id) + 1) from  CARDAPIO),1,current_date - 7,to_char(current_date - 7, 'day'));
INSERT INTO CARDAPIO_ALIMENTO(id, id_cardapio, nome)VALUES(1,1,'FEIJÃO');
INSERT INTO CARDAPIO_ALIMENTO(id, id_cardapio, nome)VALUES((select (max(id) + 1) from  CARDAPIO_ALIMENTO),1,'ARROZ');
INSERT INTO CARDAPIO_ALIMENTO(id, id_cardapio, nome)VALUES((select (max(id) + 1) from  CARDAPIO_ALIMENTO),1,'BATATA');
INSERT INTO CARDAPIO_ALIMENTO(id, id_cardapio, nome)VALUES((select (max(id) + 1) from  CARDAPIO_ALIMENTO),1,'SUCO DE LIMÃO');
INSERT INTO CARDAPIO_ALIMENTO(id, id_cardapio, nome)VALUES((select (max(id) + 1) from  CARDAPIO_ALIMENTO),1,'CENOURA');
INSERT INTO CARDAPIO_ALIMENTO(id, id_cardapio, nome)VALUES((select (max(id) + 1) from  CARDAPIO_ALIMENTO),1,'CARNE');
INSERT INTO CARDAPIO_ALIMENTO(id, id_cardapio, nome)VALUES((select (max(id) + 1) from  CARDAPIO_ALIMENTO),1,'LENTILHA');
INSERT INTO CARDAPIO_ALIMENTO(id, id_cardapio, nome)VALUES((select (max(id) + 1) from  CARDAPIO_ALIMENTO),1,'ABÓBORA');
INSERT INTO CARDAPIO_ALIMENTO(id, id_cardapio, nome)VALUES((select (max(id) + 1) from  CARDAPIO_ALIMENTO),1,'AIPIM');
INSERT INTO CARDAPIO_ALIMENTO(id, id_cardapio, nome)VALUES((select (max(id) + 1) from  CARDAPIO_ALIMENTO),2,'ALFACE');
INSERT INTO CARDAPIO_ALIMENTO(id, id_cardapio, nome)VALUES((select (max(id) + 1) from  CARDAPIO_ALIMENTO),2,'MASSA INTEGRAL');
INSERT INTO CARDAPIO_ALIMENTO(id, id_cardapio, nome)VALUES((select (max(id) + 1) from  CARDAPIO_ALIMENTO),2,'RÚCULA');
INSERT INTO CARDAPIO_ALIMENTO(id, id_cardapio, nome)VALUES((select (max(id) + 1) from  CARDAPIO_ALIMENTO),2,'CARNE MOÍDA');
INSERT INTO CARDAPIO_ALIMENTO(id, id_cardapio, nome)VALUES((select (max(id) + 1) from  CARDAPIO_ALIMENTO),2,'PEIXE');
INSERT INTO CARDAPIO_ALIMENTO(id, id_cardapio, nome)VALUES((select (max(id) + 1) from  CARDAPIO_ALIMENTO),2,'PERU');
INSERT INTO CARDAPIO_ALIMENTO(id, id_cardapio, nome)VALUES((select (max(id) + 1) from  CARDAPIO_ALIMENTO),2,'PÃO INTEGRAL');
INSERT INTO CARDAPIO_ALIMENTO(id, id_cardapio, nome)VALUES((select (max(id) + 1) from  CARDAPIO_ALIMENTO),2,'POLENTA COM MOLHO');
INSERT INTO CARDAPIO_ALIMENTO(id, id_cardapio, nome)VALUES((select (max(id) + 1) from  CARDAPIO_ALIMENTO),2,'OVO');
INSERT INTO CARDAPIO_ALIMENTO(id, id_cardapio, nome)VALUES((select (max(id) + 1) from  CARDAPIO_ALIMENTO),2,'MAÇA');
INSERT INTO CARDAPIO_ALIMENTO(id, id_cardapio, nome)VALUES((select (max(id) + 1) from  CARDAPIO_ALIMENTO),3,'FEIJÃO');
INSERT INTO CARDAPIO_ALIMENTO(id, id_cardapio, nome)VALUES((select (max(id) + 1) from  CARDAPIO_ALIMENTO),3,'ARROZ');
INSERT INTO CARDAPIO_ALIMENTO(id, id_cardapio, nome)VALUES((select (max(id) + 1) from  CARDAPIO_ALIMENTO),3,'BATATA');
INSERT INTO CARDAPIO_ALIMENTO(id, id_cardapio, nome)VALUES((select (max(id) + 1) from  CARDAPIO_ALIMENTO),3,'SUCO DE LIMÃO');
INSERT INTO CARDAPIO_ALIMENTO(id, id_cardapio, nome)VALUES((select (max(id) + 1) from  CARDAPIO_ALIMENTO),3,'CENOURA');
INSERT INTO CARDAPIO_ALIMENTO(id, id_cardapio, nome)VALUES((select (max(id) + 1) from  CARDAPIO_ALIMENTO),3,'CARNE');
INSERT INTO CARDAPIO_ALIMENTO(id, id_cardapio, nome)VALUES((select (max(id) + 1) from  CARDAPIO_ALIMENTO),3,'LENTILHA');
INSERT INTO CARDAPIO_ALIMENTO(id, id_cardapio, nome)VALUES((select (max(id) + 1) from  CARDAPIO_ALIMENTO),3,'ABÓBORA');
INSERT INTO CARDAPIO_ALIMENTO(id, id_cardapio, nome)VALUES((select (max(id) + 1) from  CARDAPIO_ALIMENTO),3,'AIPIM');
INSERT INTO CARDAPIO_ALIMENTO(id, id_cardapio, nome)VALUES((select (max(id) + 1) from  CARDAPIO_ALIMENTO),4,'ALFACE');
INSERT INTO CARDAPIO_ALIMENTO(id, id_cardapio, nome)VALUES((select (max(id) + 1) from  CARDAPIO_ALIMENTO),4,'MASSA INTEGRAL');
INSERT INTO CARDAPIO_ALIMENTO(id, id_cardapio, nome)VALUES((select (max(id) + 1) from  CARDAPIO_ALIMENTO),4,'RÚCULA');
INSERT INTO CARDAPIO_ALIMENTO(id, id_cardapio, nome)VALUES((select (max(id) + 1) from  CARDAPIO_ALIMENTO),4,'CARNE MOÍDA');
INSERT INTO CARDAPIO_ALIMENTO(id, id_cardapio, nome)VALUES((select (max(id) + 1) from  CARDAPIO_ALIMENTO),4,'PEIXE');
INSERT INTO CARDAPIO_ALIMENTO(id, id_cardapio, nome)VALUES((select (max(id) + 1) from  CARDAPIO_ALIMENTO),4,'PERU');
INSERT INTO CARDAPIO_ALIMENTO(id, id_cardapio, nome)VALUES((select (max(id) + 1) from  CARDAPIO_ALIMENTO),4,'PÃO INTEGRAL');
INSERT INTO CARDAPIO_ALIMENTO(id, id_cardapio, nome)VALUES((select (max(id) + 1) from  CARDAPIO_ALIMENTO),4,'POLENTA COM MOLHO');
INSERT INTO CARDAPIO_ALIMENTO(id, id_cardapio, nome)VALUES((select (max(id) + 1) from  CARDAPIO_ALIMENTO),4,'OVO');
INSERT INTO CARDAPIO_ALIMENTO(id, id_cardapio, nome)VALUES((select (max(id) + 1) from  CARDAPIO_ALIMENTO),4,'MAÇA');
INSERT INTO CARDAPIO_ALIMENTO(id, id_cardapio, nome)VALUES((select (max(id) + 1) from  CARDAPIO_ALIMENTO),5,'FEIJÃO');
INSERT INTO CARDAPIO_ALIMENTO(id, id_cardapio, nome)VALUES((select (max(id) + 1) from  CARDAPIO_ALIMENTO),5,'ARROZ');
INSERT INTO CARDAPIO_ALIMENTO(id, id_cardapio, nome)VALUES((select (max(id) + 1) from  CARDAPIO_ALIMENTO),5,'BATATA');
INSERT INTO CARDAPIO_ALIMENTO(id, id_cardapio, nome)VALUES((select (max(id) + 1) from  CARDAPIO_ALIMENTO),5,'SUCO DE LIMÃO');
INSERT INTO CARDAPIO_ALIMENTO(id, id_cardapio, nome)VALUES((select (max(id) + 1) from  CARDAPIO_ALIMENTO),5,'CENOURA');
INSERT INTO CARDAPIO_ALIMENTO(id, id_cardapio, nome)VALUES((select (max(id) + 1) from  CARDAPIO_ALIMENTO),5,'CARNE');
INSERT INTO CARDAPIO_ALIMENTO(id, id_cardapio, nome)VALUES((select (max(id) + 1) from  CARDAPIO_ALIMENTO),5,'LENTILHA');
INSERT INTO CARDAPIO_ALIMENTO(id, id_cardapio, nome)VALUES((select (max(id) + 1) from  CARDAPIO_ALIMENTO),5,'ABÓBORA');
INSERT INTO CARDAPIO_ALIMENTO(id, id_cardapio, nome)VALUES((select (max(id) + 1) from  CARDAPIO_ALIMENTO),6,'AIPIM');
INSERT INTO CARDAPIO_ALIMENTO(id, id_cardapio, nome)VALUES((select (max(id) + 1) from  CARDAPIO_ALIMENTO),6,'ALFACE');
INSERT INTO CARDAPIO_ALIMENTO(id, id_cardapio, nome)VALUES((select (max(id) + 1) from  CARDAPIO_ALIMENTO),6,'MASSA INTEGRAL');
INSERT INTO CARDAPIO_ALIMENTO(id, id_cardapio, nome)VALUES((select (max(id) + 1) from  CARDAPIO_ALIMENTO),6,'RÚCULA');
INSERT INTO CARDAPIO_ALIMENTO(id, id_cardapio, nome)VALUES((select (max(id) + 1) from  CARDAPIO_ALIMENTO),6,'CARNE MOÍDA');
INSERT INTO CARDAPIO_ALIMENTO(id, id_cardapio, nome)VALUES((select (max(id) + 1) from  CARDAPIO_ALIMENTO),6,'PEIXE');
INSERT INTO CARDAPIO_ALIMENTO(id, id_cardapio, nome)VALUES((select (max(id) + 1) from  CARDAPIO_ALIMENTO),6,'PERU');
INSERT INTO CARDAPIO_ALIMENTO(id, id_cardapio, nome)VALUES((select (max(id) + 1) from  CARDAPIO_ALIMENTO),6,'PÃO INTEGRAL');
INSERT INTO CARDAPIO_ALIMENTO(id, id_cardapio, nome)VALUES((select (max(id) + 1) from  CARDAPIO_ALIMENTO),6,'POLENTA COM MOLHO');
INSERT INTO CARDAPIO_ALIMENTO(id, id_cardapio, nome)VALUES((select (max(id) + 1) from  CARDAPIO_ALIMENTO),6,'OVO');
INSERT INTO CARDAPIO_ALIMENTO(id, id_cardapio, nome)VALUES((select (max(id) + 1) from  CARDAPIO_ALIMENTO),6,'MAÇA');
INSERT INTO CARDAPIO_ALIMENTO(id, id_cardapio, nome)VALUES((select (max(id) + 1) from  CARDAPIO_ALIMENTO),7,'ARROZ');
INSERT INTO CARDAPIO_ALIMENTO(id, id_cardapio, nome)VALUES((select (max(id) + 1) from  CARDAPIO_ALIMENTO),7,'BATATA');
INSERT INTO CARDAPIO_ALIMENTO(id, id_cardapio, nome)VALUES((select (max(id) + 1) from  CARDAPIO_ALIMENTO),7,'SUCO DE LIMÃO');
INSERT INTO CARDAPIO_ALIMENTO(id, id_cardapio, nome)VALUES((select (max(id) + 1) from  CARDAPIO_ALIMENTO),7,'CENOURA');
INSERT INTO CARDAPIO_ALIMENTO(id, id_cardapio, nome)VALUES((select (max(id) + 1) from  CARDAPIO_ALIMENTO),7,'CARNE');
INSERT INTO CARDAPIO_ALIMENTO(id, id_cardapio, nome)VALUES((select (max(id) + 1) from  CARDAPIO_ALIMENTO),7,'LENTILHA');
INSERT INTO CARDAPIO_ALIMENTO(id, id_cardapio, nome)VALUES((select (max(id) + 1) from  CARDAPIO_ALIMENTO),7,'ABÓBORA');
INSERT INTO CARDAPIO_ALIMENTO(id, id_cardapio, nome)VALUES((select (max(id) + 1) from  CARDAPIO_ALIMENTO),8,'AIPIM');
INSERT INTO CARDAPIO_ALIMENTO(id, id_cardapio, nome)VALUES((select (max(id) + 1) from  CARDAPIO_ALIMENTO),8,'ALFACE');
INSERT INTO CARDAPIO_ALIMENTO(id, id_cardapio, nome)VALUES((select (max(id) + 1) from  CARDAPIO_ALIMENTO),8,'MASSA INTEGRAL');
INSERT INTO CARDAPIO_ALIMENTO(id, id_cardapio, nome)VALUES((select (max(id) + 1) from  CARDAPIO_ALIMENTO),8,'RÚCULA');
INSERT INTO CARDAPIO_ALIMENTO(id, id_cardapio, nome)VALUES((select (max(id) + 1) from  CARDAPIO_ALIMENTO),8,'CARNE MOÍDA');
INSERT INTO CARDAPIO_ALIMENTO(id, id_cardapio, nome)VALUES((select (max(id) + 1) from  CARDAPIO_ALIMENTO),8,'PEIXE');
INSERT INTO CARDAPIO_ALIMENTO(id, id_cardapio, nome)VALUES((select (max(id) + 1) from  CARDAPIO_ALIMENTO),8,'PERU');
INSERT INTO CARDAPIO_ALIMENTO(id, id_cardapio, nome)VALUES((select (max(id) + 1) from  CARDAPIO_ALIMENTO),8,'PÃO INTEGRAL');
INSERT INTO CARDAPIO_ALIMENTO(id, id_cardapio, nome)VALUES((select (max(id) + 1) from  CARDAPIO_ALIMENTO),8,'POLENTA COM MOLHO');
INSERT INTO CARDAPIO_ALIMENTO(id, id_cardapio, nome)VALUES((select (max(id) + 1) from  CARDAPIO_ALIMENTO),8,'OVO');
INSERT INTO CARDAPIO_ALIMENTO(id, id_cardapio, nome)VALUES((select (max(id) + 1) from  CARDAPIO_ALIMENTO),8,'MAÇA');